...
from Thing0 import Thing  # Importa a classe base Thing do módulo Thing0, usada para representar objetos no ambiente.
...
class Agent(Thing): 
    ...
    def __init__(self, program=None):  # Método inicializador para criar um agente.
        ...
        if program is None or not isinstance(program, collections.abc.Callable):
            ...
            print("\n    Não foi possível encontrar um programa válido para {}, usando o padrão.".format(self.__class__.__name__))
    ...
    def can_grab(self, thing):  # Método para verificar se o agente pode pegar um objeto.
